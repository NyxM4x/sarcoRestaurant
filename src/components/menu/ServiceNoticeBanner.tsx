 ...
 *
 * Solo se pinta en las tres franjas que decide `serviceNoticeAt`: media hora
 * antes de abrir, el cuarto de hora alrededor del cierre, y el día entero con
 * el local cerrado. El resto del tiempo el componente no se renderiza —no
 * devuelve un contenedor vacío— para que no quede un hueco reservado a algo que
 * no está.
 *
 * ── Los tres avisos NO pesan lo mismo ───────────────────────────────────────
 *
 * "Estamos abriendo" y "atención fuera de horario" acompañan a un cliente que
 * probablemente igual va a comer hoy: son contexto, y van en tono suave para no
 * gritarle a quien ya está pidiendo.
 *
